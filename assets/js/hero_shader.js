// Shader-in-banner renderer
(function () {
  // Find the banner-scoped container that we inject from page-banner.html
  var container =
    document.getElementById('shader-banner') ||
    document.querySelector('.page-banner .shader-fill');

  if (!container) return; // not the home page or no banner container

  var canvas = container.querySelector('#webgl-canvas') || document.createElement('canvas');
